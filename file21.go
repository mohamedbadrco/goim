		...
		if(rand.Intn(255) > 1){
			...
			pimage(dc, color.RGBA{uint8( rc[0]),uint8(rc[1]), uint8(rc[2]), uint8(((aA/8)) >>  8) },
				...
				if(am[x][y][1] == 0){
					...
					rpimage(dc, color.RGBA{uint8( rc[0]),uint8(rc[1]), uint8(rc[2]), uint8(aA  >>  8) },
					x * 14 + xo[y] ,o + 16 + 14 + y *14,string(gscale[am[x][y][0]]))
				rpimage(dc, color.RGBA{uint8( rc[0]),uint8(rc[1]), uint8(rc[2]), uint8(((aA/8)) >>  8) },
					x * 14 + 7 + xo[y] ,o + 16 + 21 + y *14,string(gscale[am[x][y][0]]))
				...
				if(am[x][y][1] == 0){
					...
					pimage(dc, color.RGBA{uint8( rc[0]),uint8(rc[1]), uint8(rc[2]), uint8(aA  >>  8) },
					x * 14 + offrand1 ,16 + y *14 + offrand2,string(gscale[am[x][y][0]]))
				pimage(dc, color.RGBA{uint8( rc[0]),uint8(rc[1]), uint8(rc[2]), uint8(((aA/8)) >>  8) },
